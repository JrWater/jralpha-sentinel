...
def _raw_policy():
    return {
        ...
        "session": {
            "competition_starts_utc": "2099-01-01T00:00:00+00:00",
            "timezone": "America/New_York", "no_new_exposure_before": "10:00",
            "no_new_exposure_after": "15:30", "final_trading_date": "2099-01-01",
            "flatten_all_at": "10:45", "no_new_exposure_on_final_date": True,
        ...
        "strategies": {
            "trend_income": {
                ...
                "structures": ["credit_vertical"],
                "exit_loss_kind": "multiple", "take_profit_fraction": 0.5,
                "stop_loss_multiple": 2.0,
            },
            "event_macro": {
                "max_loss_per_trade_fraction": 0.10,
                "gap_max_loss_fraction": 0.08,
                "structures": ["single_long"],
                "exit_loss_kind": "fraction", "take_profit_fraction": 0.5,
                "stop_loss_fraction": 0.5, "gap_max_entries_total": 1,
            },
        },
        "order_shapes": [],

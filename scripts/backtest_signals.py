...
def main() -> int:
    ...
    print(f"\nTHRESHOLD={THRESHOLD} — edge = mean signal-forward return minus "
          f"SPY forward return. Positive edge means the Trend Vector would "
          f"have bought relative strength that continued.")
    return 0
